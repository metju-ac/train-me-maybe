const csTranlation = {
  ...
  "Failed to save details to account": "Nepodařilo se uložit detaily do účtu",
  ...
  "Credit Number": "Číslo kreditu",
  "The Regiojet number of your credit ticket (e.g. 123456789). A.k.a. 'číslo kreditové jizdenky'":
    "Číslo kreditové jízdenky Regiojet (např. 123456789). Také známé jako 'číslo kreditové jízdenky'",
  "Credit Password": "Heslo ke kreditu",
  ...
  "Time in minutes before the train departure when the last autopurchase can be made. E.g. 120 means that watched routes will be purchased no less than 2 hours before the train departure.":
    "Čas v minutách před odjezdem vlaku, kdy lze provést poslední automatický nákup. Např. 120 znamená, že sledované trasy budou zakoupeny nejméně 2 hodiny před odjezdem vlaku.",
  ...
  "Selected date": "Vybraný datum",
  Route: "Trasa",
  "No routes available for this date 😢 - please try different stations and date 👉👈":
    "Pro tento datum nejsou k dispozici žádné trasy 😢 - zkuste prosím jiné stanice a datum 👉👈",
  ...
  "If checked, we will try to purchase the ticket for you. You will need to provide Regiojet credentials, and you need to have sufficient credit.":
    "Pokud je zaškrtnuto, pokusíme se zakoupit jízdenku za vás. Budete muset poskytnout přihlašovací údaje Regiojet a mít dostatečný kredit.",
  ...
  Email: "E-mail",
  Password: "Heslo",
  "First fill out the form": "Nejprve vyplňte formulář",
  ...
  "Route created successfully!": "Trasa úspěšně vytvořena!",
  "Failed to create route": "Nepodařilo se vytvořit trasu",
  "Route deleted successfully!": "Trasa úspěšně smazána!",
  "Failed to delete route": "Nepodařilo se smazat trasu",
  "Successfully logged in": "Úspěšně přihlášen",
