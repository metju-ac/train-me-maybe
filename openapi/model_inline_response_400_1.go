...
// checks if the InlineResponse4001 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse4001{}
...
func (o InlineResponse4001) ToMap() (map[string]interface{}, error) {
...
func (o *InlineResponse4001) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varInlineResponse4001)
