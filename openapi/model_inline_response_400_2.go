...
// checks if the InlineResponse4002 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse4002{}
...
func (o InlineResponse4002) ToMap() (map[string]interface{}, error) {
...
func (o *InlineResponse4002) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varInlineResponse4002)
