...
// checks if the InlineResponse4005 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse4005{}
...
type _InlineResponse4005 InlineResponse4005
...
func (o InlineResponse4005) ToMap() (map[string]interface{}, error) {
...
func (o *InlineResponse4005) UnmarshalJSON(data []byte) (err error) {
	...
	*o = InlineResponse4005(varInlineResponse4005)
